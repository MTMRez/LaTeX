...
\begin{document}
    ...
    \photoL{4cm}{20230225_121952_small}

    \personalinfo{
        \email{marcostadeurez@icloud.com}\smallskip
        \phone{+5531992580796}
        \location{Betim, Brazil}\\
        %\linkedin{linkedin.com/in/marcos-tadeu-magalh\%C3\%A3es-rezende-0a737a204/}
        \github{github.com/MTMRez}
        %\npm{npmUser}
        %\dev{devtoUser}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{TECH STACK}
            ...
            \begin{sloppypar*}
                \cvtags{Angular, Bootstrap, C, C++, C\#, CSS, Git, Go, HTML, Java, JavaScript, Kotlin, Python, R, SQL, Swift, TypeScript}
                % \medskip
        ...
        \cvsection{Experience}
            \cvevent{Front-End Developer}{MMTools Consultoria e Projetos de Informática Ltda., alias OneBeleza}{Jun 2021 -- Sep 2021}{Belo Horizonte, Brazil}
            \begin{itemize}
                \item Front-End Developer
                \item Tryouts at Back-End Developer
            \end{itemize}
            \divider
        ...
        % ----- EDUCATION -----
        \cvsection{Education}
            \cvevent{High School}{Instituto Educacional Novos Tempos}{Jul 2004 -- Dec 2015}{Contagem, Brazil}
            %\begin{itemize}
            %    \item GPA: 1,23
            %\end{itemize}
            \divider
            
            \cvevent{Bachelor at Accounting Science (Two periods)}{Pontifícia Universidade Católica de Minas Gerais}{Fev 2016 -- Dec 2016}{Belo Horizonte, Brazil}
            \divider
            
            \cvevent{Bachelor at Computer Science}{Pontifícia Universidade Católica de Minas Gerais}{Fev 2017 -- Aug 2023}{Belo Horizonte, Brazil}
            \divider
            
            \cvevent{Specialization at Artificial Intelligence and Machine Learning}{Pontifícia Universidade Católica de Minas Gerais}{Aug 2023 -- Jul 2024}{Belo Horizonte, Brazil}
        % ----- EDUCATION -----
